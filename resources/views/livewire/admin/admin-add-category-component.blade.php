        ...
        <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="white-box">
                <div class="d-md-flex mb-3">
                    <div class="col-md-6" >
                        <h3 class="box-title mb-0">Thêm danh mục</h3>
                    </div>
                ...
                <div class="card">
                    ...
                    @endif
                        <form class="form-horizontal form-material" wire:submit.prevent="newCategory">
                            <div class="form-group mb-4 d-md-flex">
                                ...
                                <div class="col-md-6 ">
                                    <input type="text" placeholder="Tên sản phẩm" class="form-control" style="padding: 12px;" wire:model="name" wire:keyup="generateslug"> 
