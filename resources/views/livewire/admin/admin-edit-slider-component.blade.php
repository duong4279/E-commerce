        ...
        <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="white-box">
                <div class="d-md-flex mb-3">
                    <div class="col-md-6" >
                        <h3 class="box-title mb-0">Cập nhật slider</h3>
                    </div>
                ...
                <div class="card">
                    ...
                    @endif
                        <form class="form-horizontal form-material" wire:submit.prevent="updateSlider">
                            ...
                            <div class="form-group mb-4 d-md-flex">
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    @else 
                                    <img src="{{ asset('assets/images/sliders') }}/{{ $image }}" style="height: auto; width: 160px; margin-top: 20px;"/>
                                    @endif
