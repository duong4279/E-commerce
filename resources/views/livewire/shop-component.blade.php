    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                <div class="wrap-right">
                    <div class="sort-item orderby ">
                        <select name="orderby" class="use-chosen"  wire:model="sorting">
                            ...
                            <option value="date">Sản phẩm cũ - mới</option>
                    ...
                    <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                        <div class="product product-style-3 equal-elem ">
                            ...
                            <div class="product-info">
                                ...
                                <a href="#" class="btn add-to-cart" wire:click.prevent="store('{{$product->id}}','{{$product->name}}','{{$product->price}}')">Thêm vào giỏ hàng</a>
                            </div>
                        </div>
                    </li>
                    @endforeach
            ...
            <div class="wrap-pagination-info">
                ...
                <p class="result-count">Showing 1-{{$pagesize}} of 12 result {{$sorting}}</p> -->
            </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
            ...
            <div class="widget mercado-widget filter-widget price-filter">
                ...
                <span class="text-info"><b>{{number_format($min_price, 0, '', ',')}}</b></span>
                <span class="text-info" style="float: right;"><b>{{number_format($max_price, 0, '', ',')}}</b></span>
                <div class="widget-content">
                    ...
                    <ul class="products">
                        <li class="product-item">
                            <div class="product product-widget-style">
                                ...
                                <div class="product-info">
                                    <a href="#" class="product-name"><span>Oppo</span></a>
