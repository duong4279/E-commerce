				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu right-menu">
							<ul>
							<li class="menu-item" ><a title="Cart" href="{{route('product.cart')}}">Giỏ Hàng</a></li>
							<li class="menu-item" ><a title="Checkout" href="{{route('product.checkout')}}">Thanh toán</a></li>
							@if(Route::has('login'))
									@auth
										...
										<li class="menu-item menu-item-has-children parent" >
											...
											<ul class="submenu curency" >
                                            <li class="menu-item" >
													<a title="Home" href="{{ route('user.dashboard') }}" >Dashboard</a>
												</li>
												<li class="menu-item">
													<a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Đăng xuất</a>
												</li>
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-icon right-section">
							...
							<div class="wrap-icon-section minicart" style="border: 1px solid #58595b; border-radius: 20px; background:#e2e2e2">
								<a href="{{route('product.cart')}}" class="link-direction">
									<i class="fa fa-shopping-cart" aria-hidden="true" style="padding-left:16px"></i>
									<div class="left-info"  style="padding-top:5px">
										@if(Cart::count() > 0)
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								<li class="menu-item">
									<a href="/" class="link-term mercado-item-title">Trang chủ</a>
								</li>
								<!-- <li class="menu-item">
